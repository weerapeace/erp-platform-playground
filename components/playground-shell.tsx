...
const navGroups = [
  ...
  },
  {
    ...
    label: "Operations",
    items: [
      { href: "/purchase-requests", icon: "📋", labelTH: "ใบขอซื้อ (PR)" },
  ...
  },
  {
    ...
    items: [
      { href: "/design-system",       icon: "🎨", labelTH: "Design System" },
      { href: "/components-preview",  icon: "🧩", labelTH: "UI Components" },
      { href: "/table-playground",    icon: "📊", labelTH: "Table Playground" },
      { href: "/form-playground",     icon: "📝", labelTH: "Form Playground" },
      { href: "/popup-playground",    icon: "🪟", labelTH: "Popup Playground" },
      { href: "/picker-playground",   icon: "🔍", labelTH: "Picker Playground" },
      { href: "/plugin-playground",   icon: "🔌", labelTH: "Plugin Playground" },
      { href: "/permission-preview",  icon: "🔒", labelTH: "Permission Preview" },
      { href: "/workflow-playground", icon: "⚙️", labelTH: "Workflow Playground" },
      { href: "/file-upload-preview", icon: "📁", labelTH: "File Upload" },
      { href: "/report-preview",      icon: "🖨️", labelTH: "Report Preview" },
      { href: "/products-demo",       icon: "📦", labelTH: "Products Demo" },
      { href: "/products-crud",       icon: "✏️", labelTH: "Products CRUD (legacy)" },
      { href: "/purchase-request-demo", icon: "📋", labelTH: "PR Demo" },
    ],
  },
];
