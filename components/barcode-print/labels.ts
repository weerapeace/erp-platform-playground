...
export type PrintOpts = {
  showQR: boolean;
  /**
   * QR เก็บ "ลิงก์" แทน "รหัสเปล่า" — ส่องด้วยแอปกล้องมือถือธรรมดาแล้วเปิดหน้าสินค้าได้เลย
   * (บาร์โค้ดเส้นยังเป็นรหัสเปล่าเสมอ เพราะลิงก์ยาวทำให้เส้นกว้างจนอ่านไม่ออก)
   * ป้ายที่พิมพ์ไปแล้วเก็บรหัสเปล่า — ยังใช้กับเครื่องยิง/หน้าสถานีสแกนได้ตามปกติ
   */
  qrLink?: boolean;
