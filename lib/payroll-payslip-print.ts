...
/**
 * รายการที่ "ไม่พิมพ์บนสลิป" (และไม่นับใน 'รวมรายได้' ที่พิมพ์ด้วย)
 *
 * ⚠️ กติกาที่เจ้าของยืนยันเอง 2026-08-31 — อย่าแก้กลับว่าเป็นบั๊ก:
 *   สลิปต้องไม่มีทางถอดเงินเดือนกลับได้ → ทั้งบรรทัดเงินเดือนและยอดรวมที่พิมพ์
 *   ต้องคิดจาก "เฉพาะบรรทัดที่เห็น" (เช่น มีแต่ OT ก็โชว์รวมรายได้ = ยอด OT)
 *   ส่วนยอดจ่ายสุทธิยังเป็นยอดจริง (เข้ารหัสไว้) จึงไม่เท่ากับ รวมรายได้ − รวมหัก โดยตั้งใจ
