...
const EDITABLE = new Set(["title", "task_id", "campaign_id", "brand_id", "sku_id", "parent_sku_id", "product_name", "post_type", "platforms", "status", "scheduled_at", "published_url", "posted_links", "post_status", "platform_images", "note", "discount_value", "discount_is_percent", "color_source", "assignee_id", "assignee_ids"]);
