...
const EDITABLE = new Set(["name", "task_type", "default_priority", "brand_id", "default_reviewer_id", "due_offset_days", "description", "platforms", "steps", "content_items", "require_parent_sku", "icon", "no_brand_only"]);
