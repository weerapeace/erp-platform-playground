...
function jsonError(error: unknown, status = 500): NextResponse<ReportLayoutDefaultResponse> {
  const message = error instanceof Error ? error.message : "report layout default error";
