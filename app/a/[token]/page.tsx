...
// ============================================================
// หน้าอนุมัติเล็ก (เปิดจากลิงก์ใน LINE) — สาธารณะ ไม่ต้อง login
// ยืนยันตัวตนด้วย LINE (LIFF) → กดอนุมัติ/ตีกลับได้เลย · ไม่ต้องเข้าทั้งระบบ
// ต้องตั้ง env: NEXT_PUBLIC_LINE_LIFF_ID (endpoint LIFF ชี้มา /a) — ยังไม่ตั้ง = โชว์ข้อความแนะนำ
// ============================================================
import { useCallback, useEffect, useState, type ReactNode } from "react";
import { useParams } from "next/navigation";

type LiffSdk = { init: (o: { liffId: string }) => Promise<void>; isLoggedIn: () => boolean; login: () => void; getIDToken: () => string | null };
...
function loadLiff() {
  return new Promise<void>((resolve, reject) => {
    ...
    s.src = LIFF_SCRIPT; s.async = true;
