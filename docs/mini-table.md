...
| `searchValue` + `onSearchChange` | คุมคำค้นจากภายนอก — ใส่ค่าเดียวกันให้หลายตาราง = **พิมพ์ครั้งเดียวกรองทุกตาราง** (ใช้ที่บอร์ดจ่ายงาน: รอจ่าย + จ่ายแล้ว) · ไม่ส่ง = ตารางเก็บคำค้นของตัวเองเหมือนเดิม |
